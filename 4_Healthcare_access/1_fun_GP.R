...
#load raw OP dataset
d_raw = readRDS('S://NDL/MouleshWorkings/3_HC_access/GP/GP_adj_fin_agecat.Rda')

# load age_gender_OP_imd datset
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/GP/groups_count.csv')

path = 'S://NDL/MouleshWorkings/3_HC_access/GP/'
...
####
# cont age
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/GP/groups_count_ageCont.csv')
