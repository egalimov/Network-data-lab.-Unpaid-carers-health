...
#load raw OP dataset
d_raw = read.csv('S://NDL/MouleshWorkings/3_HC_access/OP/OP_adj_fin_agecat.csv')

# load age_gender_OP_imd datset
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/OP/groups_count.csv')
...
####
# cont age
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/OP/groups_count_ageCont.csv')
