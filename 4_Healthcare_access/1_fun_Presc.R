...
#load raw OP dataset
d_raw = readRDS('S://NDL/MouleshWorkings/3_HC_access/Presc/Presc_adj_fin_agecat.Rda')

# load age_gender_OP_imd datset
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/Presc/groups_count.csv')
...
####
# cont age
d = read.csv('S://NDL/MouleshWorkings/3_HC_access/Presc/groups_count_ageCont.csv')
