...
events_un = events[!duplicated(events$PatientKey),
              c('PatientKey','age','Gender','carer','IMDDecile','Appts')]
...
write.csv(count_merged, 'S://NDL/MouleshWorkings/3_HC_access/Presc/logr_data.csv')
count_merged = read.csv('S://NDL/MouleshWorkings/3_HC_access/Presc/logr_data.csv')
